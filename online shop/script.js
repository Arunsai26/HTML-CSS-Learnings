  ...
  <div class="card">
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="headingOne">
          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse${product.id}" aria-expanded="true" aria-controls="collapseOne">
          <span id="read-more">Read Description</span>
          </button>
        </h2>
...
// <div class="card-subtitle">${product.description.split(" ").slice(0,11).join(" ")} <span id="read-more">Read more....</span></div>